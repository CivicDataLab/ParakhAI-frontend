...
A Next.js frontend for the Parakh AI platform, built to manage AI models, run evaluations, and support auditor workflows for model testing and quality review.
