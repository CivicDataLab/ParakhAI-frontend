      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-lg text-gray-700 mb-8 max-w-2xl">
            ...
            <strong>trust</strong> through participatory, automated-assisted,
            and expert-led evaluations with ParakhAI
          </p>

          <Button
            kind="primary"
            onClick={handleGetStarted}
            className="bg-[#26007B] flex items-center justify-end gap-2 hover:bg-[#6849EE]  px-8 py-3 rounded-[8px]"
          >
